...
import { WhatsappMsg } from '../dashboard/whatsapp-msg';
import { LakeRows } from '../dashboard/lake-rows';
import Tooltip, { tooltipClasses } from '@mui/material/Tooltip';
import CircularProgress from '@mui/material/CircularProgress';
import api from '../../lib/axios';
import { MsgInsOuts } from '../dashboard/msg-ins-outs';
import { SocialAgents } from '../dashboard/social-agents';
  ...
  switch (action.type) {
    ...
    case 'SET_PURCHASES':
      return {
        ...
        msgLimit: action.payload.msgLimit,
        rowLimit: action.payload.rowLimit,
      };
    case 'SET_LOADING':
    ...
    const fetchData = async () => {
      try {
        ...
        if (companyResponse.data.success) {
          dispatch({
            type: 'SET_COMPANY',
            payload: { isConsumption: companyResponse.data.company.credit_msg_consumption },
          });
          ...
          if (purchasesResponse.data.success) {
            ...
            dispatch({
              type: 'SET_PURCHASES',
              payload: { activePurchases: active, msgLimit, rowLimit },
            });
          }
  ...
  return (
    <Box component="main" sx={{ flexGrow: 1, py: 15 }}>
      <Container sx={{ paddingLeft: 36, paddingRight: 36 }}>
        ...
        <Grid container spacing={3} justifyContent="center">
          ...
          <Grid item xs={12} sm={6} md={4} lg={4} xl={4}>
            ...
            >
              <Box>
                <LakeRows companyId={companyId} isConsumption={state.isConsumption} rowLimit={state.rowLimit} />
              </Box>
            </LightTooltip>
          </Grid>
          <Grid item
      ...
      <Container sx={{ paddingLeft: 36, paddingRight: 36, mt: 6 }}>
        ...
        <Grid item xs={12}>
          {/* Uncomment if you need to use MsgInsOuts component */}
          {/* <MsgInsOuts /> */}
        </Grid>
      </Container>
    </Box>
